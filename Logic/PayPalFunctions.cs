...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-43u8go1261641_api1.business.example.com";
    private string APIPassword = "2YPAFY44KBXZBUSZ";
    private string APISignature = "AEUBpq7P1dHj8eZtBGXd5ExDjqkPABU6JKQjeOiSlMdHJBRJohsVhlb1";
   ...
   retMsg)
    {
        ...
        string returnURL = "http://localhost:44339/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:44339/Checkout/CheckoutCancel.aspx";
